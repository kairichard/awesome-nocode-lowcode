...
- [Stack Architect](https://stackarchitect.xyz/) - Open-source automation resource hub providing plug-and-play Make.com blueprints for server-side marketing APIs and Shopify stack optimization.
...
- [Gatherly](https://gatherly.shop) - E-signature and client intake platform for professional services with document requests, eIDAS-qualified signatures, and automated reminders.
...
- [Convertigo](https://www.convertigo.com/) - Open-source enterprise low-code platform for governed forms and workflow applications.
...
- [Convertigo](https://www.convertigo.com/) - Open-source enterprise low-code platform for web, mobile, PWA, and offline-capable applications.
...
- [Convertigo](https://www.convertigo.com/) - Open-source enterprise low-code platform for full-stack web applications, APIs, workflows, and integrations.
